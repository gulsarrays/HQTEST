...
class PaymentLib {
    ...
    public function collectCreditCardParemeter() {

        // collect all the post data into variables 
        $customer_name = $_POST['customer_name'];
        $total_amount = $_POST['item_price'];
        $currency = $_POST['currency'];

        $card_holder = $_POST['cc_name'];
